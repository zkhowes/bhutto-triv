...
export default function NavBar() {
  ...
  // Show profile completion banner instead of aggressive redirect
  // (redirect is handled by dashboard and join pages specifically)
    ...
    <nav className="sticky top-0 z-50 bg-[#1a1a2e]/95 backdrop-blur border-b border-[#1e3a5f]">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-14">
          ...
          >
            <svg className="w-5 h-5 text-[#a0a0b8]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="flex items-center gap-3">
            {/* Workshop icon (mobile only — desktop has text link) */}
            <Link
              href="/questions/workshop"
              className="flex md:hidden items-center justify-center w-8 h-8 rounded-full bg-[#1e3a5f] text-[#a0a0b8] hover:text-white hover:bg-[#254a73] transition-colors"
