  ...
  return (
    <div className="space-y-4">
      ...
      <div className="card p-5">
        ...
        {/* Row 2: Correct answer + question score */}
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              {round.questionScore.successRate != null && (
                <span className="text-xs text-[#666680]">
                  {Math.round(round.questionScore.successRate * 100)}%
                </span>
              )}
              <div className="relative">
                ...
                {showScoreInfo && (
                  <div className="absolute right-0 top-7 z-10 w-56 p-3 rounded-lg bg-[#16162a] border border-[#1e3a5f] shadow-lg">
                    <p className="text-xs text-[#a0a0b8]">
